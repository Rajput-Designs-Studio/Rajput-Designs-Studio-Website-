...
function ServiceCard({ service, index }) {
  return (
    <FadeIn delay={index * 0.1} y={30}>
      <div
        className="flex flex-col sm:flex-row gap-6 sm:gap-8 md:gap-12 py-8 sm:py-10 md:py-12 border-l-2 border-[hsl(var(--primary))] pl-6 sm:pl-8 mb-6 rounded-r-2xl hover:bg-[hsla(var(--primary)/0.08)] transition-colors duration-300 group"
        style={{
      ...
      >
        <div
          ...
          style={{ fontSize: 'clamp(3rem, 10vw, 120px)', lineHeight: 0.85 }}
        >
          {service.number}
        </div>
